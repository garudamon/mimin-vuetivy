export default {
  ...
  state: {
    ...
    drawerCollapse: localStorage.getItem('drawerCollapse'),
  },
  mutations: {
    toggleDrawer(state) {
      let current = localStorage.getItem('drawerCollapse');
      if (!current) current = 'false';
      let target = current === 'false' ? 'true' : 'false';
      state.drawerCollapse = target;
      localStorage.setItem('drawerCollapse', target);
    },
  },
  actions: {},
  getters: {},
